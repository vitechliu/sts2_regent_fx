...
public static class FixedOpeningHandPatch {
    ...
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<StrikeRegent>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<MakeItSo>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<StrikeRegent>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<FallingStar>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<ParticleWall>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<PillarOfCreation>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<Glow>(player),
    //         Traverse.Create(combatState).Method("CreateCard").GetValue<Genesis>(player),
    //     };
    //
    //     // 在这里定义你想要的固定手牌
