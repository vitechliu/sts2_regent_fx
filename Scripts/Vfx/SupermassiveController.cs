...
public partial class SupermassiveController : Node2D {
    ...
    public bool TryLaunch(Creature target) {
        ...
        //todo 超质量体攻击音效
        FmodLite.Play("event:/RegentFx/sfx/supermassive_launch", "size", _latestScale);
        _flightTween?.Kill();
    ...
    private void CreateOrb(bool playGrow) {
        ...
        try {
            ...
            //todo 超质量体产生音效
            FmodLite.Play("event:/RegentFx/sfx/supermassive_create", "size", _latestScale);
            _lifecycleVersion++;
            _orb = orb;
    ...
    private void PlayOneShotAnimation(Node2D parent, StringName animation, int zIndex) {
        ...
        FmodLite.Play("event:/RegentFx/sfx/supermassive_grow", "size", _latestScale);
